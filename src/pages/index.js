...
export const Guides = [
  {
    ...
    text: 'Integrate with the Ribon Protocol using JavaScript',
    to: '#',
  }
]
...
export const quick = [
  ...
  {
    title: 'Whitepaper',
    text: 'Read the Ribon whitepaper',
    to: 'https://ribon.io/wp-content/uploads/2021/08/Protocolo-Ribon-Whitepaper-v.0.2.pdf',
  },
]
...
export default function Home() {
  return (
    <Layout title={`Ribon Docs`} description="Technical Documentation For The Ribon Protocol">
      <Container>
        <DocsHeader>
          <div
            style={{
          ...
          >
            <h1 style={{ fontWeight: '600' }}> Welcome to the Ribon Docs</h1>
            <HideMedium>
              <SearchBar />{' '}
            </HideMedium>
          </div>
          <StyledTitleImage
            ...
            sources={{
              light: useBaseUrl('/img/home_banner.png'),
              dark: useBaseUrl('/img/home_banner.png'),
            }}
          />
          <Row>
            {actions.map((action) => (
        ...
        >
          <div>
            ...
            <p>
              Explore these docs to get started integrating the Ribon Protocol in your dApp, smart contract or
              project.
            </p>
            <div>
              {Guides.map((action) => (
          ...
          <div>
            ...
            <p>The Ribon codebase is comprised of an ecosystem of open source components.</p>
            {github.map((action) => (
        ...
        <Row>
          <Link style={{ textDecoration: 'none' }} href={'https://discord.gg/BVjycZYE4Q'}>
            <CenterCard>
          ...
          <Link style={{ textDecoration: 'none' }} href={'https://github.com/RibonDAO'}>
            <CenterCard>
              <StyledGithubIcon>
              ...
              <div>
                <h3>GitHub</h3>
                <p>View all Ribon repositories.</p>
              </div>
            </CenterCard>
          </Link>
        </Row>
